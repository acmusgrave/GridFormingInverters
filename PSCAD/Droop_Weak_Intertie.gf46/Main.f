...
! 50:[breaker3] 3 Phase Breaker 'BRK_1'
      IVD1_4 = NSTORI
      NSTORI = NSTORI + 3
! Three Phase Breaker
...
! 120:[sandhdefn] Sample and Hold 
!  Sample and Hold
      CALL SANDH2(RT_9,S2M,  1,  RT_10)

! 130:[hy_gov] Hydro Governor 
...
! 150:[sync_machine] Synchronous Machine 'HydroGener'
...
! 160:[excac_2016] Type AC Exciter IEEE Std. 421.5-2016 
...
! Internal Variables
      INTEGER  IVD1_1
      REAL     RVD1_1, RVD1_2, RVD3_1(3), RVD1_3
      REAL     RVD1_4
...
! 110:[freq-meas] Frequency/Incremental Phase/RMS Meter 
...
! 170:[pgb] Output Channel 'f_bus_1'

      PGB(IPGB+1) = RT_2

! 180:[pgb] Output Channel 'f_bus2'
