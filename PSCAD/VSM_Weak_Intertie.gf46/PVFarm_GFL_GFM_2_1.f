...
!
!
      CALL EMTDC_X2COMP(0,0,3.0,RT_11,0.1,0.0,500.0,RVD2_1)
      m_VSM_var = RVD2_1(1)
...
! 250:[SimpleSF_15_2_1]  
     ...
     & 5.0, 30.0, 1, 2, 20.0, 200.0, 0.5, 20.0, 30.0, 1.0, 1.0, 0.5, 20.&
     &0, 0.1, 0.25, 0.5, 100.0, 3.0, 10.0, 22.22, 10.0, 0.01, 0.5, 20.0,&
     & 0.5, 20.0, 1.2, 0.8, 1.3, 0.2, 1.0, 20.0, 0.333, m_VSM_var)
...
! 250:[SimpleSF_15_2_1]  
     ...
     &e, 0.65, 1.4, 0.2, 0, 2, 0.1, 0.25, 0.2)
