...
! Subroutine Arguments
      INTEGER, INTENT(IN)  :: N_units! Aliases: UN
...
! Control Signals
      ...
      REAL     RT_9, inv_Srate, RT_10, m_VSM_var
      REAL     RT_11
...
!---------------------------------------
      ...
      Vbase    = STOF(ISTOF + 5)
      Fbase    = STOF(ISTOF + 6)
      Rated_MW = STOF(ISTOF + 7)
      RT_5     = STOF(ISTOF + 8)
      Q_POC    = STOF(ISTOF + 9)
      P_POC    = STOF(ISTOF + 10)
      Vrms_POC = STOF(ISTOF + 11)
      RT_6     = STOF(ISTOF + 18)
      RT_7     = STOF(ISTOF + 19)
      RT_8     = STOF(ISTOF + 20)
      RT_9     = STOF(ISTOF + 21)
      inv_Srate = STOF(ISTOF + 22)
      RT_10    = STOF(ISTOF + 23)
      m_VSM_var = STOF(ISTOF + 24)
      RT_11    = STOF(ISTOF + 25)

! Array (1:3) quantities...
      DO IT_0 = 1,3
         Igrid_POC(IT_0) = STOF(ISTOF + 11 + IT_0)
         Vgrid_POC(IT_0) = STOF(ISTOF + 14 + IT_0)
      END DO
...
!
!
      CALL EMTDC_X2COMP(0,0,2.0,RT_10,0.1,0.0,10.0,RVD2_1)
      m_VSM_var = RVD2_1(1)

! 150:[mult] Multiplier 
      RT_8 = REAL(N_units) * Rated_MW

! 160:[mult] Multiplier 
      RT_7 = RT_11 * REAL(N_units)
...
! 250:[SimpleSF_15_2_1]  
      CALL SimpleSF_15_2_1Dyn(RT_1, RT_2, NINT(RT_3), RT_4, N_units, Fba&
     &se, Rated_MW, Vbase, 0.65, 1.4, 0.2, 0, 1.0, 0.0, 1.0, -0.5, 5.0, &
     &30.0, 1, 2, 20.0, 200.0, 0.5, 20.0, 30.0, 1.0, 1.0, 0.5, 20.0, 0.1&
     &, 0.25, 0.5, 100.0, 3.0, 10.0, 22.22, 10.0, 0.01, 0.5, 20.0, 0.5, &
     &20.0, 1.2, 0.8, 1.3, 0.2, 1.0, 20.0, 0.0333, m_VSM_var)
...
!---------------------------------------
      ...
      STOF(ISTOF + 5) = Vbase
      STOF(ISTOF + 6) = Fbase
      STOF(ISTOF + 7) = Rated_MW
      STOF(ISTOF + 8) = RT_5
      STOF(ISTOF + 9) = Q_POC
      STOF(ISTOF + 10) = P_POC
      STOF(ISTOF + 11) = Vrms_POC
      STOF(ISTOF + 18) = RT_6
      STOF(ISTOF + 19) = RT_7
      STOF(ISTOF + 20) = RT_8
      STOF(ISTOF + 21) = RT_9
      STOF(ISTOF + 22) = inv_Srate
      STOF(ISTOF + 23) = RT_10
      STOF(ISTOF + 24) = m_VSM_var
      STOF(ISTOF + 25) = RT_11

! Array (1:3) quantities...
      DO IT_0 = 1,3
         STOF(ISTOF + 11 + IT_0) = Igrid_POC(IT_0)
         STOF(ISTOF + 14 + IT_0) = Vgrid_POC(IT_0)
      END DO
...
! 250:[SimpleSF_15_2_1]  
      CALL SimpleSF_15_2_1Dyn_Begin(N_units, Fbase, Rated_MW, Vbase, 0.6&
     &5, 1.4, 0.2, 0, 2, 0.1, 0.25, 0.2)
...
! 250:[SimpleSF_15_2_1]  
      CALL SimpleSF_15_2_1Out_Begin(N_units, Fbase, Rated_MW, Vbase, 0.6&
     &5, 1.4, 0.2, 0, 2, 0.1, 0.25, 0.2)
